    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        @media (max-width: 480px) {
            .success-body { padding: 28px 20px 32px; }
            .success-header { padding: 36px 20px 32px; }
        }
    </style>
</head>
<body>
    ...
    <div class="success-card">
        ...
        <div class="success-body">
            <div class="success-message">
                <p>
                    <span class="highlight">Hoàn tất!</span> Mật khẩu tài khoản của bạn đã được đổi thành công.
