    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        @media (max-width: 480px) {
            .otp-body { padding: 28px 20px 32px; }
            .otp-header { padding: 28px 20px 22px; }
            .otp-input-group input { width: 44px; height: 52px; font-size: 20px; }
    ...
    <div class="otp-card">
        ...
        <div class="otp-header">
            ...
            <p>
                ...
                <span class="email-highlight">${sessionScope.resetEmail}</span>
            </p>
        </div>
        ...
        <div class="otp-body">
            ...
            <div class="resend-section">
                ...
                <form action="<c:url value='/resend-reset-otp'/>" method="post" style="display: inline;">
            ...
            <a href="<c:url value='/forgot-password'/>" class="back-link">
