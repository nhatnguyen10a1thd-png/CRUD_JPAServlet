...
<title>Xác Thực OTP Quên Mật Khẩu - System Admin</title>
...
<div class="auth-card">
    ...
    <div class="auth-header header-amber">
        ...
        <h1>Xác Thực OTP</h1>
        <p>
            Mã OTP đặt lại mật khẩu đã gửi đến<br>
            <strong class="text-white"><c:out value="${sessionScope.resetEmail}"/></strong>
        </p>
    </div>
    ...
    <div class="auth-body">
        ...
        <form action="<c:url value='/verify-reset-otp'/>" method="post" id="otpForm">
            <!-- 6 OTP Input Boxes -->
            ...
            <!-- Verify Button -->
            <button type="submit" class="btn btn-warning text-white w-100 py-2 fw-semibold d-flex align-items-center justify-content-center gap-2" id="btnVerify">
        ...
        <div class="resend-section">
            ...
            <form action="<c:url value='/resend-reset-otp'/>" method="post" class="d-inline">
        ...
        <div class="text-center pt-4 mt-4 border-top">
            <a href="<c:url value='/forgot-password'/>" class="text-secondary small text-decoration-none fw-semibold">
...
<script>
    ...
    // ===== Countdown Timer =====
    <%
        long otpExpiry = session.getAttribute("resetOtpExpiry") != null
